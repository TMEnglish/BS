...
\documentclass[11pt]{article}
    ...
    \def\lt{<}
    % Document parameters
    \title{Numerical study of the main theorem (sd=0.006, beneficial=1e-14)}
...
\makeatother
    ...
    \section{Numerical Study of the Main Theorem (sd=0.006,
beneficial=1e-14)}\label{numerical-study-of-the-main-theorem-sd0.006-beneficial1e-14}
...
{\color{incolor}In [{\color{incolor}1}]:} \PY{n}{standard\PYZus{}deviation\PYZus{}in\PYZus{}fitness\PYZus{}of\PYZus{}initial\PYZus{}population} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{0.006}\PY{l+s+s1}{\PYZsq{}} \PY{c+c1}{\PYZsh{} Levels: 0.006, 0.013, 0.020}
...
Fitness of initial population
    Mean         : -6.9827334793666859079909038749833619218383893402208e-53
    Std deviation:  0.0060017358600102798370514449513180949180344835142829
    Variance     :  0.000036020833333333333333333333333333333333333333333333
...
Evaluation of Eq. 3.4 at time 0
    Variance                      : +3.60208333333333257e-05
    Correction                    : -9.83222891693883024e-05
    Rate of change in mean fitness: -6.23014558360549767e-05
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Predicted change in mean fitness at time x=1/128 is -4.867301237191795e-07
...
Predicted change: -4.867301237191795e-07
Observed change : -4.867212119590363e-07
Relative error  : 1.8309783761642088e-05
...
Report from initial value problem solver
    ...
    Derivative evaluations: 7680812
CPU times: user 27min 30s, sys: 10.3 s, total: 27min 41s
Wall time: 13min 51s
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}13}]:} <matplotlib.animation.FuncAnimation at 0x7fa270127a90>
\end{Verbatim}
